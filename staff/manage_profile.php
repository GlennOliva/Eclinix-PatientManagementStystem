<?php
include('../components/staff_header_staff.php');
...
?>
		...
		<main>
			...
			<ul class="breadcrumbs">
				...
				<li class="divider">/</li>
				<li><a href="#" class="active">Update Staff Profile</a></li>
			</ul>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="mb-3">
                                ...
                                <img src="../admin/staff_image/<?php echo $current_image;?>" style="width: 30%; margin: 2%;">
                            </div>
                            <div class="mb-3">
                                <label for="adminFullname" class="form-label">Staff Full Name</label>
                            ...
                            <div class="mb-3">
                                <label for="adminUsername" class="form-label">Staff Username</label>
                                <input type="text" class="form-control" name="adminUsername" placeholder="Enter username" value="<?php echo $username;?>">
                            </div>
                            <div class="mb-3">
                                <label for="adminPhoneNumber" class="form-label">Staff Phone Number</label>
                            ...
                            <div class="mb-3">
                                <label for="adminPhoneNumber" class="form-label">Staff Current Password</label>
                                <input type="password" class="form-control" name="adminCurrentpassword" placeholder="Enter current password">
                                
                            </div>

                            <div class="mb-3">
                                <label for="adminPhoneNumber" class="form-label">Staff New Password</label>
    ...
    if(isset($_POST['update_profile']))
    {
        ...
        if(isset($_FILES['adminImage']['name']))
        {
            ...
            if($image_name!="")
            {
                ...
                $destination_path = "../admin/staff_image/".$image_name;
                ...
                if($current_image!="")
                {
                    ...
                    $remove_path = "../admin/staff_image/".$current_image;
        ...
        $sql1 = "SELECT * FROM  tbl_staff WHERE id = $id && password = '$current_password'";
        ...
        $sql = "UPDATE tbl_staff SET full_name = '$admin_name' , email = '$admin_email', username = '$admin_username',
        ...
        if($result == True)
        {
            ...
            swal({
                title: "Success",
                text: "Staff Profile Successfully Update",
                icon: "success"
            }).then(function() {
