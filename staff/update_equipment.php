                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="mb-3">
                                ...
                                <img src="../admin/equipment_image/<?php echo $current_image;?>" style="width: 30%; margin: 2%;">
                            </div>
                            <div class="mb-3">
    ...
    if(isset($_POST['update_medical']))
    {
        ...
        if(isset($_FILES['medicalImage']['name']))
        {
            ...
            if($image_name!="")
            {
                ...
                $destination_path = "../admin/equipment_image/" . $image_name;
                ...
                if($current_image!="")
                {
                    ...
                    $remove_path = "../admin/equipment_image/".$current_image;
