...
<body>
	...
	<section id="sidebar">
		...
		<li style="padding-top: 3%;"><a href="dashboard.php" ><i class='bx bxs-dashboard icon' ></i> Dashboard</a></li>
		...
		<li>
			...
			<li><a href="patient_list.php" ><i class='bx bxs-user-circle icon'></i> Patient List</a></li>
			<li><a href="manage_inventory.php"><i class='bx bxs-capsule icon'></i>Medicine Records</a></li>
			<li><a href="manage_equipments.php" class="active"><i class='bx bxs-store-alt icon'></i>Equipments Records</a></li>
