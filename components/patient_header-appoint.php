...
<body>
	...
	<section id="sidebar">
		...
		<li style="padding-top: 3%;"><a href="manage_calendar.php" ><i class='bx bxs-calendar icon' ></i>Appointment Calendar</a></li>
			<li><a href="manage_appoint.php" class="active"><i class='bx bxs-calendar-week icon' ></i>Appointment</a></li>
