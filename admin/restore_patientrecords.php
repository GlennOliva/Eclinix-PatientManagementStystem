...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($record_id > 0) {
        ...
        try {
            ...
            $query = "SELECT * FROM tbl_archivepatientrecords  WHERE id = ?";
            ...
            if ($result && mysqli_num_rows($result) > 0) {
                ...
                $insert_query = "INSERT INTO tbl_records 
                                 (patient_id, medical_id, `treatment`, `prescriptions`, `illness`, `laboratory_req`, age ) 
                                 VALUES (?, ?, ?, ?, ?, ?, ?)";
                ...
                if ($inserted) {
                    ...
                    $delete_query = "DELETE FROM tbl_archivepatientrecords  WHERE id = ?";
