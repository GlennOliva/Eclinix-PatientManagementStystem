...
?>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="mb-3">
                                ...
                                <img src="staff_image/<?php echo $current_image;?>" style="width: 30%; margin: 2%;">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
    <label for="adminStatus" class="form-label">Staff Status</label>
    <select class="form-select" id="adminStatus" name="adminStatus">
      ...
      <input type="hidden" name="current_image" value="<?php echo $current_image;?>">
                            <input type="submit" name="update_staff" class="btn btn-primary" value="Update Staff">
                        </form>
                    </div>
                </div>
            </div>
    ...
    if(isset($_POST['update_staff']))
    {
        ...
        if(isset($_FILES['adminImage']['name']))
        {
            ...
            if($image_name!="")
            {
                ...
                $destination_path = "staff_image/".$image_name;
                ...
                if($current_image!="")
                {
                    ...
                    $remove_path = "staff_image/".$current_image;
        ...
        if($result == True)
        {
            ...
            swal({
                title: "Success",
                text: "Staff Successfully Update",
                icon: "success"
            }).then(function() {
                window.location = "manage_staff.php";
            });
        ...
        exit; // Make sure to exit after performing the redirect
            ...
            echo '<script>
                swal({
                    ...
                    window.location = "update_staff.php";
                });
            </script>';
